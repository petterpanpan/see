...
<?php /*?>	<div id="help">
		...
		<div class="content">
			...
			<ul>
				<li><img src="img/puce.gif" alt="" /> <a href="http://www.iestore.cn/bbs/" target="_blank"><?php echo lang('Forum'); ?></a><br class="clear" /></li>
				<li><img src="img/puce.gif" alt="" /> <a href="http://www.iestore.cn/"><?php echo lang('Blog'); ?></a><br class="clear" /></li>
			</ul>
		</div>
	</div><?php */?>
</div>
...
<?php /*?>		<p>
			<?php echo lang('For more information, please consult our') ?> <a href="http://www.iestore.cn/bbs/"><?php echo lang('online documentation') ?></a>.
		</p><?php */?>
...
<?php /*?>		<h3 class="no-margin"><?php echo lang('Did you know?'); ?></h3>
		<p>
			...
			<form action="<?php $_SERVER['REQUEST_URI']; ?>" method="post" onsubmit="return false;" enctype="multipart/form-data">
				...
				<div class="field">
					...
					<select id="infosCountry" style="width:175px;border:1px solid #D41958">
						...
						<option value="5" selected="selected"><?php echo lang('China'); ?></option>
						...
						<option value="8"><?php echo lang('France'); ?></option>
...
<?php /*?>			<p>
		...
		<div class="sheet" id="sheet_end_update" style="padding:0px;">
			<div style="padding:1em;">
				...
				<h3><?php echo lang('WARNING: For more security, you must delete the \'install\' folder and readme files (readme_fr.txt, readme_en.txt, readme_es.txt, readme_zh.txt).'); ?></h3>
